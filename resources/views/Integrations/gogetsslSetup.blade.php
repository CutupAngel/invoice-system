...
@section('content')
		<div class="row">
			<div class="col-sm-6">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">GoGetSSL Information</h3>
					</div>
					<div class="box-body">
			...
			<div class="col-sm-6">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">GoGetSSL Import</h3><br><br>

                        <a href="/settings/ssl/gogetssl/import"><button type="button" class="btn btn-default"> <i class="fa fa-arrow-circle-o-left"></i> Import Customers</button></a>
					</div>
